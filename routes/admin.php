...
Route::get('/skbsadmin', 'AdminController@admin_dashboard')->name('admin.dashboard')->middleware(['auth', 'admin']);
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
     //Live streaming
    Route::resource('live_streaming','LiveStreamingController');
    //Update Routes
    /**
     * search brand
     */
       Route::get('search/brand','ProductController@getBrand')->name('search.brand.admin');
    /**
     * get sub category
    */
    Route::get('get_all_sub_category_by_category','ProductController@get_all_sub_category_by_category')->name('get_all_sub_category_by_category');
    /**
     * Partner
     */
    ...
    Route::post('partner/create','PartnerController@store')->name('partner.store');
     ...
     * Medicine
     */
    Route::get('medicines','BusinessSettingsController@showMedicines')->name('show.medicines');
    Route::get('medicine/destroy/{id}','BusinessSettingsController@deleteMedicine')->name('medicine.destroy');
    /**
     * Global Market
     */
    Route::get('global_market','BusinessSettingsController@showGlobalMarket')->name('show.global_market');
    Route::get('global_market/destroy/{id}','BusinessSettingsController@deleteGlobalMarket')->name('global_market.destroy');
    /**
     * Category Wise home page
     */
    Route::get('category_wise_home_page','BusinessSettingsController@showCategoryWiseHomePage')->name('show.category.wise.home_page');
    Route::post('update/category_wise_home_page','BusinessSettingsController@updateCategoryWiseHomePage')->name('update.category.wise.home_page');
    
     /*Ad Banner Slider controler start */
    Route::get('approved_ad_banner','AddBannerSliderController@index')->name('approved_ad_banner.index');
    Route::get('approved_ad_banner/create','AddBannerSliderController@createAddBannerByAdmin')->name('approved_ad_banner.create');
    Route::post('approved_ad_banner/store','AddBannerSliderController@storeAddBannerByAdmin')->name('approved_ad_banner.store');
    Route::get('approved_ad_banner/update/{id}','AddBannerSliderController@editByAdmin')->name('approved_ad_banner.edit');
    Route::put('approved_ad_banner/update/{id}','AddBannerSliderController@updateAddBannerByAdmin')->name('approved_ad_banner.update');
    Route::post('approved_by_admin','AddBannerSliderController@approvedByAdmin')->name('approved_by_admin');
    Route::post('update_priority','AddBannerSliderController@updatePriority')->name('update_priority');
      Route::get('admin/delete/{id}','AddBannerSliderController@destroy')->name('admin_slider.destroy');
    ...
    Route::get('delete-banner/{id}', 'BannerController@deletebanner')->name('banner.delete');
    
    Route::get('banner/destroyall/', 'BannerController@destroyall')->name('banner.destroy');
    
    /* Banner Ends */
    /* Home Banner Controller Start */
    Route::get('homebanner', 'HomeBannerController@index')->name('homebanner.index');
    Route::get('homebanner/create/', 'HomeBannerController@create')->name('homebanner.create');
    Route::post('homebanner/store/', 'HomeBannerController@store')->name('homebanner.store');
     Route::get('home-banner/{id}', 'HomeBannerController@deletebanner')->name('homebanner.delete');
    
    Route::get('edit-home-banner/{id}', 'HomeBannerController@editbanner')->name('homebanner.edit');
    
     Route::post('home-update-banner/{id}', 'HomeBannerController@updatebanner')->name('banner.update');
    Route::get('homebanner/destroyall/', 'HomeBannerController@destroyall')->name('homebanner.destroy');
