...
/*==================Change for dev start========================*/
    ...
    Route::get('/skbspanel', [LoginController::class, 'showLoginForm'])->name('login');
    Route::Post('/skbspanel', [LoginController::class, 'login'])->name('login');
...
* global Store
*/
Route::post('/global_market/store','BusinessSettingsController@storeGlobalMarket')->name('store.global_market');
/*
* Medicine Store
*/
Route::post('/medicine/store','BusinessSettingsController@storeMedicine')->name('store.medicine');

//offer 
Route::get('offer-up-to','BusinessSettingsController@upToOffer')->name('up_to_10');
Route::get('offer-up-to_70', 'BusinessSettingsController@upToSeventyPercentOffer')->name('up_to_70');
Route::get('offer-to-day','BusinessSettingsController@todayOffer')->name('today_offer');
Route::get('buy-one-get-one','BusinessSettingsController@buyOneGetOne')->name('buy_one_get_one');
Route::get('buy-more-save-more','BusinessSettingsController@buyMoreSaveMore')->name('buy_more_save_more');
...
//Show More
Route::get('/home/section/showmore', 'HomeController@showmore')->name('home.section.showmore');
...
Route::post('/home/section/home_skb_world', 'HomeController@load_home_skb_world_section')->name('home.section.home_skb_world');
...
Route::post('/cart/addtocarts/', 'CartController@addToCarts')->name('cart.addToCarts');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    //ad banner slider for seller
    Route::resource('/upload_ad_banner','AddBannerSliderController')->except(['destroy']);
    Route::get('upload_ad_banner/delete/{id}','AddBannerSliderController@destroy')->name('upload_ad_banner.destroy');
     ...
     * Return Product
     */
    Route::get('return_product/{id}', 'PurchaseHistoryController@returnProduct')->name('return_product');
    Route::post('return_product/{id}', 'PurchaseHistoryController@storeReturnProduct')->name('return_product.store');
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user']], function() {
     ...
     * search brand
     */
    Route::get('/seller/search/brand','ProductController@getBrand')->name('search.brand');
    
    Route::get('get_all_sub_category_by_category_seller','HomeController@get_all_sub_category_by_category_seller')->name('get_all_sub_category_by_category_seller');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    * medicine
    */
      Route::get('medicine/all','BusinessSettingsController@showMedicines')->name('show.medicine.all');
    /*
    *Global market store
    */
    ...
    Route::get('orders/print', 'InvoiceController@invoice_print')->name('invoice.print');
...
Route::get('/get_shop_name','ShopController@getShopName')->name('get_shop_name');

Route::get('/track-your-order', 'HomeController@trackOrder')->name('orders.track');

Route::get('/customer-care', 'HomeController@customerCare')->name('customer.care');
Route::post('/customer-care/store', 'HomeController@customerCareStore')->name('customer.care.store');

Route::get('/live', 'HomeController@liveMenu')->name('live');
Route::get('/entertainment', 'HomeController@entertainmentMenu')->name('entertainment');
