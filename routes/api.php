...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    ...
    //partners
    Route::get('all-partners', 'Api\V2\PartnerController@index');
    
    //Advertisement & package
    Route::get('advertisement', 'Api\V2\PackageController@advertisement');
    Route::get('corporate', 'Api\V2\PackageController@corporate');
    Route::get('platinum', 'Api\V2\PackageController@platinum');
    Route::get('ad-store', 'Api\V2\PackageController@adStore');
    ...
    Route::post('change/languages', 'Api\V2\LanguageController@changeLanguage');
    ...
    Route::post('global-market','Api\V2\BusinessSettingController@storeGlobalMarket')->middleware('auth:sanctum');
    Route::post('medicine','Api\V2\BusinessSettingController@storeMedicine')->middleware('auth:sanctum');
    //customer care 
    Route::post('/customer-care','Api\V2\BusinessSettingController@customerCare');
    

    Route::get('categories/featured', 'Api\V2\CategoryController@featured');
    Route::get('categories/home', 'Api\V2\CategoryController@home');
        Route::get('categories/skb', 'Api\V2\CategoryController@skbCategory');
    ...
    Route::post('/track-your-order', 'Api\V2\PurchaseHistoryController@trackOrder');
    ...
    Route::get('products/price', 'Api\V2\ProductController@price')->name('products.price.filter');
    ...
    Route::get('search/products/{search}', 'Api\V2\ProductController@searchProduct');
    ...
    Route::get('cart-count/{user_id}', 'Api\V2\CartController@CartCount')->middleware('auth:sanctum');
    ...
    Route::post('wishlists-check-product', 'Api\V2\WishlistController@isProductInWishlist');
    Route::post('wishlists-add-product', 'Api\V2\WishlistController@add');
    Route::post('wishlists-remove-product', 'Api\V2\WishlistController@remove');
    ...
    Route::get('policies/advertisement', 'Api\V2\PolicyController@advertisementPolicy')->name('policies.advertisement');
    Route::get('policies/customer', 'Api\V2\PolicyController@customerPolicy')->name('policies.customer');
    Route::get('policies/terms-and-condition', 'Api\V2\PolicyController@termsAndCondition')->name('policies.terms_and_condition');
    Route::get('policies/aboutUS', 'Api\V2\PolicyController@aboutUS')->name('policies.aboutUS');
    Route::get('policies/privacyPolicy', 'Api\V2\PolicyController@privacyPolicy')->name('policies.privacyPolicy');
   ...
   //offer api
    Route::get('today-offer','Api\V2\OfferController@todayOffer');
    Route::get('buy-more-save-more-offer','Api\V2\OfferController@byMoreSaveMore');
    Route::get('up-to-fifty-percent-offer','Api\V2\OfferController@upToFiftyPercent');
    Route::get('up-to-seventy-percent-offer','Api\V2\OfferController@upToSeventyPercent');
    Route::get('buy-one-get-one','Api\V2\OfferController@buyOneGetOne');
    
    //notification
    Route::get('/notification','Api\V2\NotificationController@index')->middleware('auth:sanctum');
    //live streaming
    Route::get('live_streaming','Api\V2\LiveStreamingController@index');
    
    //support ticket
    Route::get('support_ticket','Api\V2\SupportTicketController@index')->middleware('auth:sanctum');
    Route::post('support_ticket','Api\V2\SupportTicketController@store')->middleware('auth:sanctum');
    Route::get('support_ticket/show/{id}','Api\V2\SupportTicketController@show')->middleware('auth:sanctum');
    Route::get('support_ticket/ticket_replies/{id}','Api\V2\SupportTicketController@ticketReplies')->middleware('auth:sanctum');
    Route::post('support_ticket/ticket_replies/store','Api\V2\SupportTicketController@replyTicketStore')->middleware('auth:sanctum');
