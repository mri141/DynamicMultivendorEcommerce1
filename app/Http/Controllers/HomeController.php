...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        // $sliders =  AddBannerSlider::where('approved_by_admin',1)
        //                                         ->where('package_name','platinum')
        //                                         ->get();
        
        $sliders = Cache::rememberForever('sliders', function(){
            return AddBannerSlider::where('approved_by_admin',1)
                                                ->where('package_name','platinum')
                                                ->get();
        });
        
        // $slider_images =  AddBannerSlider::where('approved_by_admin',1)
        //                                         ->where('package_name','bronze')
        //                                         ->get();
      
        // $slider_images = Cache::rememberForever('sliders-adstore', function(){
        //     return AddBannerSlider::where('approved_by_admin',1)
        //                                         ->where('package_name','bronze')
        //                                         ->get();
        // });
        ...
        return view('frontend.index', compact('featured_categories', 'todays_deal_products','partners','banner','sliders'));
    }
    ...
    public function load_featured_section(){
     ...
     public function load_featured_sections(){
        return view('frontend.partials.backupfeatured_products_section');
    }
    ...
    public function load_home_skb_world_section(){
        $skb_world = Category::where('id', 1280)->first();
        
        return view('frontend.partials.home_skb_world_section',compact('skb_world'));
    }
    ...
    //customer care 
     public function customerCareStore(Request $request){
    ...
    public function liveMenu(Request $request)
    {
       
        return view('frontend.live_menu');
    }
    
     public function entertainmentMenu(Request $request)
    {
       
        return view('frontend.entertainment_menu');
    }
...
//        $categories = Category::where('level', 0)->orderBy('name', 'asc')->get();
    ...
    public function showmore(){
        return view('frontend.partials.showmore');
    }
    
    public function get_all_sub_category_by_category_seller(Request $request){
