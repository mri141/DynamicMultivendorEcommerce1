...
class ProductController extends Controller
{
    ...
    {
        return new ProductMiniCollection(Product::paginate(10));
    }
    ...
    public function price(Request $request)
    {
        ...
        ->whereBetween('unit_price',[$request->min, $request->max]);
        return new ProductMiniCollection(filter_products($products)->latest()->paginate(10));
    } 
    ...
    public function todaysDeal()
    {
        return Cache::remember('app.todays_deal', 86400, function(){
            $products = Product::where('published', 1)->where('featured', '1');
    ...
    public function home()
    {
        ...
        return new ProductCollection(Product::select("*")->inRandomOrder()->take(50)->get());
    }
}
