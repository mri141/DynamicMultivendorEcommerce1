...
class CategoryController extends Controller
{
    ...
    public function index($parent_id = 0)
    {
        ...
        return Cache::remember("app.categories-$parent_id", 86400, function() use ($parent_id){
            return new CategoryCollection(Category::where('parent_id', $parent_id)->orderBy('order_level','asc')->get());
        });
    }
    ...
    public function skbCategory()
    {

        return Cache::remember('app.skb_category', 86400, function(){
            return new CategoryCollection(Category::where('id', 1280)->get());
