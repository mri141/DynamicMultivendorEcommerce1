...
class AamarpayController extends Controller
{
    public function index(){
        ...
        if (Auth::user()->phone == null) {
            ...
            flash('Please update your phone number!')->warning();
        ...
        if(Session::has('payment_type')){
            ...
            elseif (Session::get('payment_type') == 'customer_package_payment') {
                ...
                $customer_package = CustomerPackgeDayTime::findOrFail(Session::get('payment_data')['package_amount_days_id']);
        ...
        // $payment_type = Session::get('payment_data');
        // $customer_package_controller = new CustomerPackageController;
        // return $customer_package_controller->purchase_payment_done($payment_type,'');
