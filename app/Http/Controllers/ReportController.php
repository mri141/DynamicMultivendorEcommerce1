...
class ReportController extends Controller
{
    public function stock_report(Request $request)
    {
        ...
        if ($request->has('category_id')){
            ...
            $get_categories = Category::where('parent_id', $request->category_id)->pluck('id');
            $products = Product::orderBy('created_at', 'desc')->whereIn('category_id', $get_categories)->paginate(15);
        }
