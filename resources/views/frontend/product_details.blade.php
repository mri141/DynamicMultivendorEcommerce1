                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <form id="option-choice-form">
                                ...
                                @if ($detailedProduct->choice_options != null)
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-sm-2">
                                            <div class="opacity-50 my-2">{{ \App\Models\Attribute::find($choice->attribute_id)->name ?? '' }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                            ...
                            <div class="mt-3">
                                ...
                                @else
                                    <button type="button" class="btn add-cart-btn mr-2 add-to-cart fw-600" onclick="addToCart()">
                    ...
                    <div class="bg-white mb-3 shadow-sm rounded">
                        ...
                        <div class="tab-content pt-0">
                            <div class="tab-pane fade active show" id="tab_default_1">
                                <div class="p-4">
                                    <div class="mw-100 overflow-hidden text-left aiz-editor-data" style="overflow-x:scroll!important;">
