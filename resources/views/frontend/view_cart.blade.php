...
<div class="modal fade" id="" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="form-default" role="form" action="{{route('guest.address')}}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="p-3">
                          <div class="row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control mb-3" placeholder="{{ translate('Your Name')}}" name="name"  required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
