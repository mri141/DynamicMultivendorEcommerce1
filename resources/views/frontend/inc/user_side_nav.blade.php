                ...
                @else
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('purchase_history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['purchase_history.index'])}}">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('My Order') }}</span>
                    ...
                    @if(Auth::user()->user_type == 'seller')
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('upload_ad_banner.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['my_uploads.new']) }}">
                                <i class="las la-folder-open aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate('Uploaded Ad Banner') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                    ...
                    @endif
                     ...
                     @php
                        $auth_medicine_count = \App\Models\Medicine::where('user_id',auth()->user()->id)->count();
                    @endphp
                    @if (($auth_medicine_count) > 0)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('show.medicine.all') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['my_uploads.new']) }}">
                            <i class="las la-folder-open aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ translate('Show Medicine') }}</span>
                        </a>
                    </li>
                    @endif
                ...
                {{--    @if(get_setting('classified_product') == 1)
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customer_products.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_products.index', 'customer_products.create', 'customer_products.edit'])}}">
                                <i class="lab la-sketch aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate('Post Your Ads (Avertiesment)') }}</span>
                            </a>
                        </li>
                    @endif --}}
                    ...
                    @if(Auth::user()->user_type == 'seller')
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('orders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['orders.index'])}}">
                                ...
                                <span class="aiz-side-nav-text">{{ translate('Customers Order') }}</span>
                            </a>
                        </li>
