            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="show-hide-div">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Quantity(Stock)')}} <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="low_stock_quantity"  min="0" step="1" class="form-control" required>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control aiz-selectpicker" name="offer_title" id="offer_title">
                                ...
                                <option value="today_offer">{{ translate('Today Offer')}}</option>
                                  <option value="buy_one_get_one">{{ translate('Buy One Get One')}}</option>
                                <option value="save_more_buy_more">{{translate('Save More Buy More')}}</option>
