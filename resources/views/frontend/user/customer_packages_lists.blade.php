        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 mx-auto text-center">
                    <h1 class="mb-0 fw-700">{{ translate('Ad Package for Seller') }}</h1>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                <div class="text-center mb-4 mt-3">
                                    ...
                                    <h6 class="mb-3 h5 fw-600">{{ $customer_package->getTranslation('adPosition') }}</h6>
                                    <h6 class="mb-3 h5 fw-600">{{ $customer_package->getTranslation('imageSize') }}</h6>
                                </div>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <input type="radio" name="package_amount_days"
                                                    aria-label="Radio button for following text input"
                                                    value="{{ $item->id }}">
                                            </div>
                                        </div>
                                        <p class="form-control"> Days : {{ $item->days }} , Price: {{ $item->amount }}</p>
                                    </div>
                                @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form class="" id="package_payment_form" action="{{ route('customer_packages.purchase') }}"
                    ...
                    <input type="hidden" name="package_amount_days_id" value="">
...
@section('script')
    <script type="text/javascript">
        ...
        function show_price_modal(id) {
            var packageDayTimeId = $('input[name="package_amount_days"]:checked').val();
            
           if (packageDayTimeId == undefined) {
                alert('Plase buy any package ');
                return;
            } else {
                $('input[name=customer_package_id]').val(id);
                $('input[name=package_amount_days_id]').val(packageDayTimeId);
