            ...
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                    ...
                    <div class="col-xl-9">
                      ...
                      {{--  <img class="d-block w-100 bannar1 mb-2" src="{{asset('public/upload/offer_banner/up_to_50_percent_offer.jpg')}}" alt="up_to_fifty%" style="height:328px; width:1020px"> --}}
                       <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="aiz-carousel dots-inside-bottom mobile-img-auto-height" data-arrows="false" data-dots="true" data-autoplay="true" data-infinite="true">
                            @php $slider_images = \App\Models\AddBannerSlider::where('approved_by_admin',1)->where('package_name','regular')->get();  @endphp
