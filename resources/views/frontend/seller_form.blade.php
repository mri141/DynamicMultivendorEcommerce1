                            ...
                            <div class="p-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ translate('Shop Name') }}"
                                        name="name" id="shop_name" required >
                                    <span id="message" style="display: none"><span class="text-danger">This Shop name is
                                            already exist.</span> <span>You can change this name or use this name! as your
                                            wish!</span> </span>
                                </div>
                                <div class="form-group">
    ...
    $(document).ready(function(){
     ...
     $("#shop_name").on('keyup', function(e) {
        ...
        function get_shop_name() {
            ...
            var APP_URL = "{{ route('get_shop_name') }}";
            $.ajax({
                type: "GET",
                url: APP_URL,
                dataType: "JSON",
