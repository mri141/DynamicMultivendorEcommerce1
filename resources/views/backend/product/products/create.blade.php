                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="show-hide-div">
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{translate('Quantity(Stock)')}} <span class="text-danger">*</span></label>
                                <div class="col-md-6">
...
<script type="text/javascript">
    ...
    $("#category_id").on('change', function() {
        ...
        function get_subCategoryByCategory() {
            ...
            var APP_URL = "{{ route('get_all_sub_category_by_category') }}";
            $.ajax({
                type: "GET",
                url: APP_URL,
                dataType: "JSON",
