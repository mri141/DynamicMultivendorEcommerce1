    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            <div class="px-20px mb-3">
                <input style="background-color:#fff !important;" class="form-control bg-soft-secondary border-0 form-control-sm text-white" type="text" name="" placeholder="{{ translate('Search in menu') }}" id="menu-search" onkeyup="menuSearch()">
            </div>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @php
                                $conversation = \App\Models\Conversation::where('receiver_id', Auth::user()->id)->where('receiver_viewed', '1')->get();
                                 $conversations = \App\Models\Conversation::where('receiver_id', Auth::user()->id)->where('receiver_viewed', '0')->get();
                            @endphp
                            @if(Auth::user()->user_type == 'admin' || in_array('12', json_decode(Auth::user()->staff->role->permissions)))
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('conversations.admin_index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['conversations.admin_index', 'conversations.admin_show'])}}">
                                        ...
                                        @if (count($conversation) > 0)
                                            <span class="badge badge-info">{{ count($conversations) }}</span>
                                        @endif
                                    </a>
                                </li>
                            @endif
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('banner.index')}}" class="aiz-side-nav-link" >
                                    <span class="aiz-side-nav-text">{{translate('Category Banners')}}</span>
                                </a>
                            </li>
                            
                             <li class="aiz-side-nav-item">
                                <a href="{{route('homebanner.index')}}" class="aiz-side-nav-link" >
                                    <span class="aiz-side-nav-text">{{translate('Slider Banner')}}</span>
                                </a>
                            </li>
                             <li class="aiz-side-nav-item">
                                <a href="{{ route('approved_ad_banner.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Ad Approved Banner') }}</span>
                                </a>
                            </li>
                            
                           {{-- Global Marker --}}
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('show.global_market') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Global Market') }}</span>
                                </a>
                            </li>
                            {{-- Medicines --}}
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('show.medicines') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Medicine') }}</span>
                                </a>
                            </li>
                            <!-- show category wise home page -->
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('show.category.wise.home_page') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Category Wise Home Page') }}</span>
                                </a>
                            </li>
                            <!-- all partner -->
                              <li class="aiz-side-nav-item">
                                <a href="{{ route('partner.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('All Partner') }}</span>
                                </a>
                            </li>
                            <!--HomeBanner Hard Coded -->
                            <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('live_streaming.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['live_streaming.index', 'live_streaming.create' ,'live_streaming.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Live Streaming')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
